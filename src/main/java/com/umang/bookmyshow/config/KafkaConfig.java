...
public class KafkaConfig {
    ...
    public NewTopic bookingEventsDltTopic() {
        return TopicBuilder.name(BOOKING_EVENTS_DLT).partitions(3).replicas(1).build();
    }
    ...
    public ConsumerFactory<String, BookingEvent> consumerFactory() {
        ...
        JsonDeserializer<BookingEvent> valueDeserializer = new JsonDeserializer<>(BookingEvent.class);
        valueDeserializer.addTrustedPackages("com.umang.bookmyshow.event");
